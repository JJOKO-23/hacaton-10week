...
#         filter = self.request.GET.get('filter')
#         if search:
#             context['products'] = Recipe.objects.filter(Q(title__icontains=search) |
#                                                        Q(description__icontains=search))
#         elif filter:
#             start_date = timezone.now() - timedelta(days=1)
#             context['products'] = Recipe.objects.filter(created__gte=start_date)
#
#         else:
#             context['products'] = Recipe.objects.all()
#         return context
#
#
#
